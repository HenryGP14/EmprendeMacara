...
urlpatterns = [
    ...
    # URLS de de negocio
    path('negocios/<int:negocio_id>',
         views.vwTplListaNegocios, name="list_negocios"),
    path('negocios/fanpage/info/<int:empresa_id>',
         views.vwTplInfoNegocio, name="info_negocio"),
    path('negocios/fanpage/producto-servicio/<int:empresa_id>',
         views.vwTplPrSrNegocio, name="pr_sr_negocio"),
